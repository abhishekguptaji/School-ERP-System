            ...
            <div className="collapse navbar-collapse" id="erpNavbar">
              <ul className="navbar-nav mx-auto erp-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/student/apply-form">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/student/study-material">
                    <i className="bi bi-laptop"></i> Study Material
                  </Link>
                </li>
              ...
              <Link className="nav-link" to="/reg">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/student/library">
        ...
        <nav className="navbar admin-navbar">
          <div className="container-fluid">
            <ul className="navbar-nav flex-row admin-menu mx-auto">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/student/attendence">
                  Attendence
                </Link>
              </li>
